...
- *(cli)* allow overriding config path via --config ([#265](https://github.com/jdrouet/git-metrics/pull/265))

### Fixed

- ignore broken pipe error ([#263](https://github.com/jdrouet/git-metrics/pull/263))
- remove dead code
- clippy linter update

### Other

- *(cli)* replace hand-written verbosity parsing with clap-verbosity-flag ([#264](https://github.com/jdrouet/git-metrics/pull/264))
- *(deps)* bundle dependabot bumps ([#262](https://github.com/jdrouet/git-metrics/pull/262))
- *(deps)* bump actions/cache from 4 to 5 ([#254](https://github.com/jdrouet/git-metrics/pull/254))
